...
const AD_Form_NewRooms = () => {
    ...
    const handleImageRoom = (e) => {
        setImageRoom(e.target.files[0]);
    }
        ...
        <form onSubmit={handleSubmit} className='HJ_form'>
            ...
            <div className='AD_FormRoom_images'>
                ...
                <ul className='AD_ul'>
                    ...
                    <li><img className='AD_imageRoom' src={small_photo} alt="room" /></li>
                    <li> 
                        <input  onChange={handleImageRoom} value={imageRoom} className='AD_form-image' required/>
                        <img src={new_article} alt="new room"  className='AD_new_room' /> </li>
                </ul>
            </div>

            <div className='AD_form_buttons'>
...
export default AD_Form_NewRooms
